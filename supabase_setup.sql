...
-- ============================================================
--  NEXT STEP — CREATE THE THREE USERS
--  Supabase → Authentication → Users → "Add user" (Auto Confirm ON)
--
--    field@foop.app     password = the Field PIN    (min 6 characters)
--    sales@foop.app     password = the Sales PIN
--    manager@foop.app   password = the Manager PIN
--
--  Then copy each user's UID and run:
--
